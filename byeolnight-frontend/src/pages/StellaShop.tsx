    ...
    try {
      ...
      if (response.data.success) {
        const mergedIcons = response.data.data.map((serverIcon: StellaIconType) => {
          return {
            ...serverIcon,
            name: getLocalizedIconName(serverIcon.name),
            description: serverIcon.description
          };
        });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0c0c1f] via-[#1b1e3d] to-[#0c0c1f] text-white py-6 sm:py-12 px-3 sm:px-6 mobile-optimized mobile-scroll">
      <div className="max-w-6xl mx-auto">
        ...
        {/* 포인트 획득 방법 안내 */}
        <div className="bg-[#1f2336] bg-opacity-80 backdrop-blur-md rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 mobile-card">
