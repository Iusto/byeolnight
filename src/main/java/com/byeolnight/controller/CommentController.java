...
public class CommentController {
    ...
    @Operation(
            summary = "댓글 생성",
            description = "게시글에 댓글을 작성합니다. 대댓글을 작성하려면 parentId를 포함해 요청하세요."
    )
    ...
    @Operation(
            ...
            description = "특정 게시글에 달린 모든 댓글을 조회합니다. 트리 구조로 대댓글까지 포함됩니다."
    )
    @ApiResponse(responseCode = "200", description = "댓글 트리 목록 반환")
