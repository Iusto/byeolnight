...
import com.byeolnight.domain.repository.token.PasswordResetTokenRepository;
...
class UserServiceTest {
    ...
    void updateProfileSuccess() {
        UpdateProfileRequestDto dto = new UpdateProfileRequestDto("새닉네임", "encoded-password");
